...
!function (t, e) {
    ...
    const Xi = ".bs.tab", Yi = `hide${Xi}`, Ui = `hidden${Xi}`, Gi = `show${Xi}`, Ji = `shown${Xi}`, Zi = `click${Xi}`,
        ...
        rs = "Home", as = "End", ls = "active", cs = "fade", hs = "show", ds = ":not(.dropdown-toggle)",
    ...
    const ms = ".bs.toast", ps = `mouseover${ms}`, bs = `mouseout${ms}`, vs = `focusin${ms}`, ys = `focusout${ms}`,
        ws = `hide${ms}`, As = `hidden${ms}`, Es = `show${ms}`, Cs = `shown${ms}`, Ts = "hide", ks = "show",
        $s = "showing", Ss = {animation: "boolean", autohide: "boolean", delay: "number"},
