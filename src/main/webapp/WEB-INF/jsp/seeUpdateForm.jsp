...
<div class="update-form-img" >
  <img src="https://img.freepik.com/premium-vector/online-shopping-background_18591-7225.jpg?w=2000" class="img-fluid f_image" >
</div>
<div class="f_title">
  <form>
    <div class="mb-3 input-form-position">
      <label for="sellerName" class="form-label customer-form-lable">sellerName</label>
      <input type="text" class="form-control input-box-size" id="sellerName" >
